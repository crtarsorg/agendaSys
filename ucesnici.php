...
<head>
	...
	<link rel="stylesheet" href="style2.css?27">
...
<div class="container-inner container-wide">
	...
	//sortiranje po imenu ucesnika	

	/*uksort($podaci, function($a, $b)
	{


		$coll = new Collator( 'sr-Cyrl'); 
		
		return collator_compare($coll, $a->sname,$b->sname) <0;
	});*/
